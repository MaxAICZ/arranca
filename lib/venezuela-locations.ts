export const VENEZUELA_ESTADOS: Record<string, string[]> = {
  "Distrito Capital": ["Libertador"],
  "Amazonas": ["Alto Orinoco", "Atabapo", "Atures", "Autana", "Manapiare", "Maroa", "Río Negro"],
  "Anzoátegui": ["Anaco", "Aragua", "Bolívar", "Bruzual", "Cajigal", "Carvajal", "Diego Bautista Urbaneja", "Freites", "Guanipa", "Guanta", "Independencia", "Libertad", "McGregor", "Miranda", "Monagas", "Peñalver", "Píritu", "San José de Guanipa", "San Juan de Capistrano", "Santa Ana", "Simón Bolívar", "Simón Rodríguez", "Sotillo"],
  ...
  "Cojedes": ["Anzoátegui", "Ezequiel Zamora", "Falcón", "Girardot", "Lima Blanco", "Pao de San Juan Bautista", "Ricaurte", "Rómulo Gallegos", "San Carlos", "Tinaco"],
  "Delta Amacuro": ["Antonio Díaz", "Casacoima", "Pedernales", "Tucupita"],
  "Falcón": ["Acosta", "Bolívar", "Buchivacoa", "Carirubana", "Colina", "Dabajuro", "Democracia", "Falcón", "Federación", "Jacura", "Los Taques", "Mauroa", "Miranda", "Monseñor Iturriza", "Palmasola", "Petit", "Píritu", "San Francisco", "Silva", "Sucre", "Tocópero", "Unión", "Urumaco", "Zamora"],
...
export const ESTADOS = Object.keys(VENEZUELA_ESTADOS).sort();

export const REGISTROS_MERCANTILES: Record<string, string> = {
  "Distrito Capital": "Registro Mercantil Primero, Segundo, Tercero, Cuarto, Quinto o Séptimo del Distrito Capital",
  "Miranda": "Registro Mercantil Primero, Segundo del Estado Miranda",
  "Zulia": "Registro Mercantil Primero, Segundo, Tercero o Cuarto del Estado Zulia",
  "Carabobo": "Registro Mercantil Primero o Segundo del Estado Carabobo",
  "Aragua": "Registro Mercantil Primero o Segundo del Estado Aragua",
  "Lara": "Registro Mercantil Primero o Segundo del Estado Lara",
  "Bolívar": "Registro Mercantil Primero o Segundo del Estado Bolívar",
  "Anzoátegui": "Registro Mercantil Primero o Segundo del Estado Anzoátegui",
  "Táchira": "Registro Mercantil Primero o Segundo del Estado Táchira",
  "Mérida": "Registro Mercantil Primero del Estado Mérida",
};
